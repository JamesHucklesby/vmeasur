...
cont = cont %>% mutate(EDD = start_value/73, start_value = NULL)
cont = cont %>% mutate(EDD2 = end_value/73, end_value = NULL)
cont = cont %>% mutate(ESD = max_value/73, max_value = NULL)
...
cont = cont %>% mutate(CD = (event_maxima-event_start)/FPS, event_start = NULL, fill_duration = NULL)
cont = cont %>% mutate(FD = (event_end - event_maxima)/FPS, event_end = NULL, cont_duration = NULL, event_maxima = NULL)
