...
#             width = maxo(mean_width),
#             duration = meano(mean_duration), cont_duration = meano(mean_cont_duration), fill_duration = meano(mean_fill_duration),
#             fpf = meano(FPF), ef = mean(mean_EF))
#
...
#             duration = mean(duration), cont_duration = meano(cont_duration), fill_duration = meano(fill_duration), fpf = mean(fpf), ef = mean(ef))
#
#
...
#             mean_mag = meano(mean_mag), cont_sum = meano(cont_sum), width = median(width),
#             duration = meano(duration), cont_duration = meano(cont_duration), fill_duration = meano(fill_duration), fpf = mean(fpf), ef = mean(ef))
#
# if(true){
...
#   summarise(max_n_cont = meano(max_n_cont)*2, max_mag = mean(max_mag, na.rm = TRUE),
#             mean_mag = meano(mean_mag), cont_sum = meano(cont_sum), width = median(width),
#             duration = mean(duration), cont_duration = meano(cont_duration), fill_duration = meano(fill_duration), fpf = mean(fpf), ef = mean(ef))
#
#
...
#   summarise(max_n_cont_std = sd(max_n_cont), max_n_cont = mean(max_n_cont),
#             mean_mag_std = sd(mean_mag)/sqrt(n()),mean_mag= mean(mean_mag),
#             cont_std = sd(cont_sum)/sqrt(n()), cont_sum = mean(cont_sum),
#             width_std = sd(width)/sqrt(n()),width = mean(width),
#             duration_std = sd(duration)/sqrt(n()),duration = mean(duration),
#             fpf_std = sd(fpf)/sqrt(n()),fpf = mean(fpf),
#             ef_std = sd(ef)/sqrt(n()), ef = mean(ef),
#             cont_duration_std = sd(cont_duration)/sqrt(n()),
#             cont_duration = meano(cont_duration),
#             fill_duration_std = sd(fill_duration)/sqrt(n()),
#             fill_duration = meano(fill_duration),
#             n = n()
#             )
#
# saveRDS(summ5.df, "TEST_sum.rds")
#
